...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('lessor')->create('accntng_safe', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
        ...
        Schema::connection('lessor')->create('accntng_safe_bank', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_safe_activity', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_loan', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_check', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_personnel', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_personnel_salary', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_personnel_contact', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_personnel_bank_account', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_personnel_document', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_order', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_order_item', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
			...
			$table->longText('groupeds');
			$table->longText('bundles');
			$table->timestamp('date_modified', 0);
			$table->timestamp('date_created', 0);
        });

        Schema::connection('lessor')->create('accntng_order_financial', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_order_contact', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_order_activity', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_invoice', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_invoice_item', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_invoice_financial', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_invoice_contact', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('accntng_recurring', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
