...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('lessor')->create('ctlg_product', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
        ...
        Schema::connection('lessor')->create('ctlg_product_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_grouped', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_bundle', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_recurring', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_image', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_video', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_faq', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_related', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_post', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_attribute', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_attribute_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_field', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_field_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_filter_value', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_option', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_option_value', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_variant', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_variant_stock', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_variant_variable', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_product_activity', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_review', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_category', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_category_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_brand', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('ctlg_brand_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('ctlg_product_recurring');
