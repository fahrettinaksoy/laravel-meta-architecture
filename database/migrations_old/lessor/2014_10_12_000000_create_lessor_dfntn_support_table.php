...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('lessor')->create('dfntn_spprt_department', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_department_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_ticket_status', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_ticket_status_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_feedback_status', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_feedback_status_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_priority', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_priority_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_relation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_spprt_relation_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
