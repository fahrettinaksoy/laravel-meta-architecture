...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('lessor')->create('dfntn_mrktng_campaign_type', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
        ...
        Schema::connection('lessor')->create('dfntn_mrktng_campaign_type_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_mrktng_gift_voucher_theme', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_mrktng_gift_voucher_theme_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
