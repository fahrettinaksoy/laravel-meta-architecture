...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_language', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_currency', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_country', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_city', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_district', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_geo', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_geo_zone', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_tax_class', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_tax_class_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_tax_rate', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_unit', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_unit_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_address_type', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
        ...
        Schema::connection('lessor')->create('dfntn_lclztn_address_type_translation', function (Blueprint $table) {
			$table->engine = 'InnoDB';
			$table->charset = 'utf8';
			$table->collation = 'utf8_general_ci';
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('dfntn_lclztn_tax_rate');
