...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create(self::CASH_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('type_id')->nullable()->comment('Kasa türü kimliği: nakit/banka (tanım tablosuna referans)');
        ...
        Schema::create(self::CASH_ACTIVITY_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('cash_id')->comment('Bağlı olduğu kasa (acct_cash)');
            $table->unsignedBigInteger('process_id')->nullable()->comment('Hareketi doğuran süreç kimliği (tanım tablosuna referans)');
            ...
            $table->unsignedBigInteger('branch_id')->nullable()->comment('Şube kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::LOAN_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('type_id')->nullable()->comment('Kredi türü kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('account_id')->nullable()->comment('İlişkili cari hesap kimliği (mbr_account; FK üyelik modülünde eklenir)');
            $table->unsignedBigInteger('module_group_id')->nullable()->comment('İlişkili modül grubu kimliği (polimorfik kaynak)');
            $table->unsignedBigInteger('module_type_id')->nullable()->comment('İlişkili modül türü kimliği (polimorfik kaynak)');
            $table->unsignedBigInteger('module_id')->nullable()->comment('İlişkili modül kayıt kimliği (polimorfik kaynak)');
        ...
        Schema::create(self::CHEQUE_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('type_id')->nullable()->comment('Çek türü kimliği: alınan/verilen çek (tanım tablosuna referans)');
            $table->unsignedBigInteger('account_id')->nullable()->comment('İlişkili cari hesap kimliği (mbr_account; FK üyelik modülünde eklenir)');
            $table->unsignedBigInteger('bank_id')->nullable()->comment('Çekin ait olduğu banka kimliği (banka tanım tablosuna referans)');
        ...
        Schema::create(self::EMPLOYEE_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('department_id')->nullable()->comment('Departman kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::EMPLOYEE_CONTACT_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('employee_id')->comment('Bağlı olduğu personel (acct_employee)');
            $table->unsignedBigInteger('address_type_id')->nullable()->comment('Adres türü kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::CART_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('recurring_type_id')->nullable()->comment('Abonelik/tekrar türü kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::ORDER_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('account_group_id')->nullable()->comment('Müşteri grup kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('operation_id')->nullable()->comment('Sipariş operasyon kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('status_id')->nullable()->comment('Sipariş durum kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::ORDER_ITEM_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('unit_id')->nullable()->comment('Birim kimliği: adet/kg/lt (tanım tablosuna referans)');
            $table->unsignedBigInteger('tax_class_id')->nullable()->comment('Vergi sınıfı kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::ORDER_ACTIVITY_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('order_id')->comment('Bağlı olduğu sipariş (acct_order)');
            $table->unsignedBigInteger('operation_id')->nullable()->comment('Operasyon kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('status_id')->nullable()->comment('Yeni durum kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::ORDER_SHIPMENT_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('cargo_id')->nullable()->comment('Kargo firması kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::INVOICE_TABLE, function (Blueprint $table) {
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('type_id')->nullable()->comment('Fatura türü kimliği: satış/alış/iade (tanım tablosuna referans)');
            ...
            $table->unsignedBigInteger('category_id')->nullable()->comment('Fatura kategorisi kimliği (tanım tablosuna referans)');
            ...
            $table->unsignedBigInteger('account_group_id')->nullable()->comment('Cari grup kimliği (tanım tablosuna referans)');
        ...
        Schema::create(self::REFUND_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('status_id')->nullable()->comment('İade durum kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('reason_id')->nullable()->comment('İade neden kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('action_id')->nullable()->comment('İade işlem türü kimliği: iade/değişim (tanım tablosuna referans)');
            ...
            $table->unsignedBigInteger('unit_id')->nullable()->comment('Birim kimliği (tanım tablosuna referans)');
            $table->unsignedBigInteger('tax_class_id')->nullable()->comment('Vergi sınıfı kimliği (tanım tablosuna referans)');
            $table->string('discount_type', 20)->nullable()->comment('İndirim türü: percentage/amount');
            $table->decimal('discount_value', 19, 2)->default(0)->comment('İndirim değeri (oran ya da tutar)');
        ...
        Schema::create(self::RECURRING_TABLE, function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('recurring_type_id')->nullable()->comment('Abonelik periyot türü kimliği: haftalık/aylık (tanım tablosuna referans)');
            $table->unsignedBigInteger('account_id')->nullable()->comment('İlişkili üye hesabı kimliği (mbr_account; FK üyelik modülünde eklenir)');
