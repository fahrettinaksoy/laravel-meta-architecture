...
return new class extends Migration
{
    ...
    private const FIELD_TYPE_TABLE = 'def_cat_field_type';
    private const FIELD_TYPE_TRANSLATION_TABLE = 'def_cat_field_type_translation';
    private const VARIANT_TABLE = 'def_cat_variant';
    private const VARIANT_TRANSLATION_TABLE = 'def_cat_variant_translation';
    private const VARIANT_VARIABLE_TABLE = 'def_cat_variant_variable';
    private const VARIANT_VARIABLE_TRANSLATION_TABLE = 'def_cat_variant_variable_translation';
    private const OPTION_TABLE = 'def_cat_option';
    private const OPTION_TRANSLATION_TABLE = 'def_cat_option_translation';
    private const OPTION_VALUE_TABLE = 'def_cat_option_value';
    private const OPTION_VALUE_TRANSLATION_TABLE = 'def_cat_option_value_translation';
    private const FILTER_TABLE = 'def_cat_filter';
    private const FILTER_TRANSLATION_TABLE = 'def_cat_filter_translation';
    private const FILTER_VALUE_TABLE = 'def_cat_filter_value';
    private const FILTER_VALUE_TRANSLATION_TABLE = 'def_cat_filter_value_translation';
    private const ATTRIBUTE_TEMPLATE_TABLE = 'def_cat_attribute_template';
    private const ATTRIBUTE_GROUP_TABLE = 'def_cat_attribute_group';
    private const ATTRIBUTE_GROUP_TRANSLATION_TABLE = 'def_cat_attribute_group_translation';
    private const ATTRIBUTE_VARIABLE_TABLE = 'def_cat_attribute_variable';
    private const ATTRIBUTE_VARIABLE_TRANSLATION_TABLE = 'def_cat_attribute_variable_translation';
    private const RECURRING_TYPE_TABLE = 'def_cat_recurring_type';
    private const RECURRING_TYPE_TRANSLATION_TABLE = 'def_cat_recurring_type_translation';
    private const STOCK_ENTRY_TABLE = 'def_cat_stock_entry';
    private const STOCK_ENTRY_TRANSLATION_TABLE = 'def_cat_stock_entry_translation';
    ...
    public function up(): void
    {
        Schema::create(self::BRAND_TABLE, function (Blueprint $table) {
            ...
            $table->string('code', 64)->unique()->comment('Marka kodu/slug — benzersiz');
            $table->string('image', 500)->nullable()->comment('Marka logosu dosya yolu');
        ...
        Schema::create(self::FIELD_TYPE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::FIELD_TYPE_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('field_type_id')->comment('Bağlı olduğu alan türü (def_cat_field_type)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('field_type_id')->references('field_type_id')->on(self::FIELD_TYPE_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::VARIANT_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::VARIANT_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('variant_id')->comment('Bağlı olduğu varyant (def_cat_variant)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('variant_id')->references('variant_id')->on(self::VARIANT_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::VARIANT_VARIABLE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::VARIANT_VARIABLE_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('variant_variable_id')->comment('Bağlı olduğu varyant değişkeni (def_cat_variant_variable)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('variant_variable_id')->references('variant_variable_id')->on(self::VARIANT_VARIABLE_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::OPTION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::OPTION_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('option_id')->comment('Bağlı olduğu seçenek (def_cat_option)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('option_id')->references('option_id')->on(self::OPTION_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::OPTION_VALUE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::OPTION_VALUE_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('option_value_id')->comment('Bağlı olduğu seçenek değeri (def_cat_option_value)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('option_value_id')->references('option_value_id')->on(self::OPTION_VALUE_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::FILTER_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::FILTER_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('filter_id')->comment('Bağlı olduğu filtre grubu (def_cat_filter)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('filter_id')->references('filter_id')->on(self::FILTER_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::FILTER_VALUE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::FILTER_VALUE_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('filter_value_id')->comment('Bağlı olduğu filtre değeri (def_cat_filter_value)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            $table->string('name')->comment('Değer adı');
            ...
            $table->foreign('filter_value_id')->references('filter_value_id')->on(self::FILTER_VALUE_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::ATTRIBUTE_TEMPLATE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::ATTRIBUTE_GROUP_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('attribute_template_id')->nullable()->comment('Bağlı olduğu özellik şablonu (def_cat_attribute_template); null ise bağımsız grup');
            ...
            $table->foreign('attribute_template_id')->references('attribute_template_id')->on(self::ATTRIBUTE_TEMPLATE_TABLE)->nullOnDelete();
        });

        Schema::create(self::ATTRIBUTE_GROUP_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('attribute_group_id')->comment('Bağlı olduğu özellik grubu (def_cat_attribute_group)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('attribute_group_id')->references('attribute_group_id')->on(self::ATTRIBUTE_GROUP_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::ATTRIBUTE_VARIABLE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('attribute_group_id')->nullable()->comment('Bağlı olduğu özellik grubu (def_cat_attribute_group); null ise bağımsız özellik');
            ...
            $table->foreign('attribute_group_id')->references('attribute_group_id')->on(self::ATTRIBUTE_GROUP_TABLE)->nullOnDelete();
        });

        Schema::create(self::ATTRIBUTE_VARIABLE_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('attribute_variable_id')->comment('Bağlı olduğu özellik değişkeni (def_cat_attribute_variable)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('attribute_variable_id')->references('attribute_variable_id')->on(self::ATTRIBUTE_VARIABLE_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::RECURRING_TYPE_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::RECURRING_TYPE_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('recurring_type_id')->comment('Bağlı olduğu tekrarlama planı (def_cat_recurring_type)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('recurring_type_id')->references('recurring_type_id')->on(self::RECURRING_TYPE_TABLE)->cascadeOnDelete();
        });

        Schema::create(self::STOCK_ENTRY_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
        ...
        Schema::create(self::STOCK_ENTRY_TRANSLATION_TABLE, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8mb4';
            $table->collation = 'utf8mb4_unicode_ci';
            ...
            $table->uuid('uuid')->unique()->comment('Dış sistemler ve API için benzersiz UUID kimliği');
            $table->unsignedBigInteger('stock_entry_id')->comment('Bağlı olduğu stok hareket türü (def_cat_stock_entry)');
            $table->char('language_code', 2)->default('tr')->comment('Çeviri dil kodu (ISO 639-1: tr, en)');
            ...
            $table->foreign('stock_entry_id')->references('stock_entry_id')->on(self::STOCK_ENTRY_TABLE)->cascadeOnDelete();
        });
    ...
    {
        Schema::dropIfExists(self::STOCK_ENTRY_TRANSLATION_TABLE);
        Schema::dropIfExists(self::STOCK_ENTRY_TABLE);
        Schema::dropIfExists(self::RECURRING_TYPE_TRANSLATION_TABLE);
        Schema::dropIfExists(self::RECURRING_TYPE_TABLE);
        Schema::dropIfExists(self::ATTRIBUTE_VARIABLE_TRANSLATION_TABLE);
        Schema::dropIfExists(self::ATTRIBUTE_VARIABLE_TABLE);
        Schema::dropIfExists(self::ATTRIBUTE_GROUP_TRANSLATION_TABLE);
        Schema::dropIfExists(self::ATTRIBUTE_GROUP_TABLE);
        Schema::dropIfExists(self::ATTRIBUTE_TEMPLATE_TABLE);
        Schema::dropIfExists(self::FILTER_VALUE_TRANSLATION_TABLE);
        Schema::dropIfExists(self::FILTER_VALUE_TABLE);
        Schema::dropIfExists(self::FILTER_TRANSLATION_TABLE);
        Schema::dropIfExists(self::FILTER_TABLE);
        Schema::dropIfExists(self::OPTION_VALUE_TRANSLATION_TABLE);
        Schema::dropIfExists(self::OPTION_VALUE_TABLE);
        Schema::dropIfExists(self::OPTION_TRANSLATION_TABLE);
        Schema::dropIfExists(self::OPTION_TABLE);
        Schema::dropIfExists(self::VARIANT_VARIABLE_TRANSLATION_TABLE);
        Schema::dropIfExists(self::VARIANT_VARIABLE_TABLE);
        Schema::dropIfExists(self::VARIANT_TRANSLATION_TABLE);
        Schema::dropIfExists(self::VARIANT_TABLE);
        Schema::dropIfExists(self::FIELD_TYPE_TRANSLATION_TABLE);
        Schema::dropIfExists(self::FIELD_TYPE_TABLE);
