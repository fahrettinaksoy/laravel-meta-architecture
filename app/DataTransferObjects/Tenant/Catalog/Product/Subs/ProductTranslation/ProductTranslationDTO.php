...
namespace App\DataTransferObjects\Tenant\Catalog\Product\Subs\ProductTranslation;
...
class ProductTranslationDTO extends BaseDTO
{
    public function __construct(
        ...
        #[TableColumn([])]
        #[ActionType(['store', 'update'])]
        public readonly ?string $meta_keyword = null,

        #[FormField(type: 'text', sort_order: 10)]
        #[TableColumn([])]
        #[ActionType(['store', 'update'])]
        public readonly ?string $tag = null,

        #[FormField(type: 'text', sort_order: 11)]
        #[TableColumn([])]
        #[ActionType(['store', 'update'])]
